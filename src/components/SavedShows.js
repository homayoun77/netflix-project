  ...
  return (
    <div>
      ...
      <div className='relative flex flex-col items-center group justify-center'>
        ...
        <div>
          <button className='text-gray-200 border border-gray-200 px-4 py-2 rounded my-8 font-bold hover:scale-110 transition-all' onClick={getData}>Show More</button>
        </div>
